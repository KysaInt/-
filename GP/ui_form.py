...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.navigationList.setMaximumSize(QSize(120, 16777215))
        font1 = QFont()
    ...
    def retranslateUi(self, Widget):
        Widget.setWindowTitle(QCoreApplication.translate("Widget", u"AkShare \u5de5\u5177", None))
        ...
        ___qlistwidgetitem.setText(QCoreApplication.translate("Widget", u"\u641c\u7d22", None));
        ___qlistwidgetitem1 = self.navigationList.item(1)
        ___qlistwidgetitem1.setText(QCoreApplication.translate("Widget", u"\u8bf4\u660e", None));
        ___qlistwidgetitem2 = self.navigationList.item(2)
        ___qlistwidgetitem2.setText(QCoreApplication.translate("Widget", u"\u8fd0\u884c", None));
        self.navigationList.setSortingEnabled(__sortingEnabled)

        self.label_1.setText(QCoreApplication.translate("Widget", u"\u641c\u7d22\u9875\u52a0\u8f7d\u4e2d\u2026", None))
        self.label_2.setText(QCoreApplication.translate("Widget", u"\u8bf4\u660e\u9875\u52a0\u8f7d\u4e2d\u2026", None))
        self.label_3.setText(QCoreApplication.translate("Widget", u"\u8fd0\u884c\u9875\u52a0\u8f7d\u4e2d\u2026", None))
    # retranslateUi
