...
HTML_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'litegraph_editor.html')
...
class LiteGraphWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('AYE LiteGraph 编辑器')
...
if __name__ == '__main__':
    ...
    app.setApplicationName('AYE LiteGraph')
